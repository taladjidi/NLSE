"""Draw the figure on physical_validation.md, from the same closed forms.

Run from anywhere:

    python docs/make_validation_figure.py
...
OUT = pathlib.Path(__file__).resolve().parent / "img" / "validation.png"
